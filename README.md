...
*** new updated for database intergration 
since we have hosted our database you would need a connection string to connect to the database that has been added to an .env not present in the github
to run the frontend:
ng serve
